...
export const stats = [
  { value: 2, suffix: '+', label: 'Products Shipped', description: 'MVPs and full platforms delivered to date.' },
  { value: 1, suffix: '', label: 'Founders Partnered', description: 'Startups and scaleups we work alongside.' },
  { value: 12, suffix: 'wk', label: 'Avg. Time to MVP', description: 'From kickoff to production launch.' },
  { value: 100, suffix: '%', label: 'In-House Team', description: 'No outsourcing, no handoffs, no surprises.' },
];

export const processSteps = [
  { title: 'Discovery', description: 'We map your goals, constraints, and users before writing a line of code.', visual: 'discovery' },
  { title: 'Design', description: 'Wireframes, prototypes, and a design system tailored to your brand.', visual: 'design' },
  { title: 'Build', description: 'Agile sprints with weekly demos, trunk-based development, and continuous integration.', visual: 'build' },
  { title: 'Test', description: 'Automated tests, load tests, and usability testing before launch.', visual: 'test' },
  { title: 'Launch', description: 'Zero-downtime deploy, observability, and a 90-day support window.', visual: 'launch' },
];
...
export const timeline = [
  { year: '2024', title: 'Founded', description: 'Novyra Technologies starts as a two-person studio in San Francisco.' },
  { year: '2024', title: 'First Shipped Product', description: 'Shipped an MVP for a healthtech startup in 8 weeks.' },
  { year: '2025', title: 'AI Practice', description: 'Built our first production AI agent for a client support team.' },
  { year: '2025', title: 'Product Suite', description: 'Launched LumenHR, LumenCRM, LumenTravel, and LumenKit.' },
  { year: '2026', title: 'Growing Fast', description: 'Now a six-person team partnering with founders across industries.' },
];
